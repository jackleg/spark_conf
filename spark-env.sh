...
export SPARK_HOME=/data1/cdh/opt/cloudera/parcels/CDH-5.5.1-1.cdh5.5.1.p0.11/lib/spark
export DEFAULT_HADOOP_HOME=/data1/cdh/opt/cloudera/parcels/CDH-5.5.1-1.cdh5.5.1.p0.11/lib/hadoop
